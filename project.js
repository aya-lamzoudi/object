...
function ajouter(library){
    ...
    let prix = prompt("entre le prix de livre ");
    let quantite =prompt("entre la quantite de cette livre ");
 ...
 function mettreajourquantite(library){
      ...
      let titre = prompt("s'il te plaît entre le titre du livre dont tu veux changer la quantité ");
   ...
   function Supprimer(library){
    let newlibrary;
    let titre = prompt("s'il te plaît entre le titre du livre tu veux supprimer ");
...
console.log (`
    ...
    switch (choix) {
        case 1: ajouter(library);
          break;
        case 2: affichage(library);
        break;
        case 3: recherche (library);
        break;
        case 4: mettreajourquantite(library);
        break;
        case 5:Supprimer(library)
        break;
        case 6: console.log(library.length);
        break;
    }
}while(choix=!7)
