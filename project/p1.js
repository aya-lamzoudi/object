...
function ajouter(library) {
  ...
  let prix = parseInt(prompt('entre le prix de livre '));
  ...
  console.log('cette live a ete ajoute . ');
}
function affichage(library) {
    for (let livre in library) {
        console.log ( livre , library[livre])
    }
...
function Supprimer(library) {
  ...
  if (index == -1) {
    ...
    console.log(' cette livre a ete Supprimer . ');
  }
}
